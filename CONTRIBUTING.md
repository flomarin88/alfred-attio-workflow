# Contributing to `alfred-attio-workflow`

Thank you for your interest in contributing to `alfred-attio-workflow` :tada: !
...
(cd esbuild && open alfred-attio-workflow.alfredworkflow)
```
